...
import GamePlay from "../../scenes/Uranus";

export default class PlayerXY extends Phaser.GameObjects.Sprite implements IPlayer {
    ...
    create() {
        ...
        this._body.allowGravity = true;
        this._body.setGravityY(5000);
    ...
    update(time: number, delta: number) {
        ...
        if (this._space.isDown && this.canJump) {
            this.canJump = false;
            this._body.setVelocityY(-6000);
        }
